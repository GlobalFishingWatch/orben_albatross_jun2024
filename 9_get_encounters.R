...
encounters <- 'bird_encounters'

#download encounters
encounters <- bq_table_download(paste(project_id, dataset, encounters, sep = "."))
...
readr::write_csv(encounters, "results/encounter_info_Nov.csv") #I sent this
...
# A partir de acá fueron los ejercicios de plotear pero no envie nada de esto
...
#                  "results/Nov_bird_tracks_encounter.csv", append = T)
...
ggsave(glue::glue("figs/Nov_encounter_{i}.png"), width = 8, height = 5)
